...
const TechnologyServiceOverview = ({
  lang = "fr",
  onBack,
  cards = [],
  category,
  ...
  return (
    ...
    >
      ...
      <div className="page-container relative z-10">
        <div className={`mb-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"} transition-all duration-700`}>
...
export default TechnologyServiceOverview;