...
const navContent = {
  fr: {
    ...
    navItems: [
      ...
      { key: "portfolio", label: "Portfolio", href: "#portfolio", type: "anchor" },
      { key: "process", label: "Processus", href: "#process", type: "anchor" },
  ...
  en: {
    ...
    navItems: [
      ...
      { key: "portfolio", label: "Portfolio", href: "#portfolio", type: "anchor" },
      { key: "process", label: "Process", href: "#process", type: "anchor" },
